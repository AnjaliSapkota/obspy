...
st_b = client.get_waveforms(network="IO", station="EVN", location="*", channel="HHZ", starttime=start, endtime=end)
...
common_start = max(
    tr_a.stats.starttime,
    tr_b.stats.starttime
)
...
max_shift_seconds = 40

max_shift_samples = int(
    max_shift_seconds * fs
)
